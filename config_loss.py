...
Original file is located at
    https://colab.research.google.com/drive/1hvygncL0InHMnsSuwCYRldfjKkVDNMdC
"""
    ...
    for each_loss in criterion:
        ...
        try:
            for e in range(epoch):
                ...
                plot(train_accuracy, val_accuracy, train_loss, val_loss, save_path + "/" + criterion_name[criterion.index(each_loss)])
